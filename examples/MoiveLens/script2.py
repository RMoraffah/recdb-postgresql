...
def main():
	...
	password = raw_input("Enter the password of postgresql: ")
        ...
        #First data set
	UserDataPath = raw_input("Enter the abs path for the first set of user data(.CSV file): ")

	ItemDataPath = raw_input("Enter the abs path for the first set of item data(.CSV file):: ")

	RatingDataPath = raw_input("Enter the abs path for the first set of ratings data(.csv file): ")
